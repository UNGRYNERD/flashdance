    ...
    <div class="box-header">
      <div class="container">
        <div class="row justify-content-center">
          ...
          @if ( get_field('activar_cuenta_atras') == 1 )
            <div class="col-12 col-md-10">
                <div class="row justify-content-center row-countdown" countdown data-date="{{ get_field('fecha_estreno') }}">
                  <div class="col-md-2 col-auto">
                    <span data-days>0</span>
                  <p>{{ __('dias', 'flashdance') }}</p>
                  </div>
                  <div class="col-md-2 col-auto">
                    <span data-hours>0</span>
                    <p>{{ __('horas', 'flashdance') }}</p>
                  </div>
                  <div class="col-md-2 col-auto">
                    <span data-minutes>0</span>
                    <p>{{ __('minutos', 'flashdance') }}</p>
                  </div>
                  <div class="col-md-2 col-auto">
                    <span data-seconds>0</span>
                    <p>{{ __('segundos', 'flashdance') }}</p>
                  </div>
                </div>
            </div>
          @endif 

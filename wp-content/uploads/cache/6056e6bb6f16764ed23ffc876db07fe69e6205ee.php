...
<footer class="content-info">
  <div class="container">
    ...
    <div class="row justify-content-between row-logos">
      <div class="col-auto">
        <img src="<?= App\asset_path('images/logo/logo_sellador.svg'); ?>;" alt="">
      </div>
      <div class="col-auto">
        <img src="<?= App\asset_path('images/logo/logo_marika.svg'); ?>;" alt="">
      </div>
      <div class="col-auto">
        <img src="<?= App\asset_path('images/logo/logo_yamaha.svg'); ?>;" alt="">
      </div>
      <div class="col-auto">
        <img src="<?= App\asset_path('images/logo/logo_pays.svg'); ?>;" alt="">
      </div>      
    </div>
    <div class="row">
